...
/***/
//Zigbee read sensor
Blockly.Blocks['Zigbee_readsensor'] = {
  init: function() {
    this.setHelpUrl('http://www.example.com/');
    this.setColour(210);
    this.appendDummyInput().appendField("ZigBee GoGo Read Sensor")
    .appendField(new Blockly.FieldDropdown([["1", "1"], ["2", "2"], ["3", "3"], ["4", "4"]]), "sensor");
...
//Zigbee dev. on/off
Blockly.Blocks['Zigbee_control'] = {
  init: function() {
    this.setHelpUrl('http://www.example.com/');
    this.setColour(210);
    this.appendDummyInput().appendField("ZigBee GoGo turn")
    .appendField(new Blockly.FieldDropdown([["ON", "1"], ["OFF", "0"]]), "onoff");
    this.appendDummyInput().appendField("Output")
    .appendField(new Blockly.FieldDropdown([["1", "1"], ["2", "2"], ["3", "3"], ["4", "4"]]), "output");
    this.appendValueInput("address")
        .appendField("Address");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
...
//Zigbee command
Blockly.Blocks['Zigbee_command'] = {
  init: function() {
    this.setHelpUrl('http://www.example.com/');
    this.setColour(210);
    this.appendValueInput("address")
        .appendField("ZigBee Command Device");
...
//Zigbee readAttr
Blockly.Blocks['Zigbee_readAttr'] = {
  init: function() {
    this.setHelpUrl('http://www.example.com/');
    this.setColour(210);
    this.appendValueInput("address")
        .appendField("ZigBee ReadAttribute Device");
    this.appendValueInput("cluster")
        .appendField(" Cluster ");
    this.appendValueInput("attribute")
        .appendField(" Attribute ");
...
//Zigbee writeAttr
Blockly.Blocks['Zigbee_writeAttr'] = {
  init: function() {
    this.setHelpUrl('http://www.example.com/');
    this.setColour(210);
    this.appendValueInput("address")
        .appendField("ZigBee WriteAttribute Device");
    this.appendValueInput("cluster")
        .appendField(" Cluster ");
    this.appendValueInput("attribute")
        .appendField(" Attribute ");
