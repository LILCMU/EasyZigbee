...
// ZigBee 
Blockly.GogoCode['Zigbee_readsensor'] = function(block) {
  var address = Blockly.GogoCode.valueToCode(block, 'address', Blockly.GogoCode.ORDER_ATOMIC);
  var sensor = this.getFieldValue('sensor');

  //  var code = '<span class="c210">zigbeeread [reg_address: '+text_reg_addr+', i2c_address: '+text_i2c_addr+']</span>\n';
  var code = '<span class="c210">zbInput '+sensor+' '+address+'</span>';
    return [code, Blockly.GogoCode.ORDER_NONE];
  };
  Blockly.GogoCode['Zigbee_control'] = function(block) {
    var onoff = this.getFieldValue('onoff');
    var address = Blockly.GogoCode.valueToCode(block, 'address', Blockly.GogoCode.ORDER_ATOMIC);
    var output = this.getFieldValue('output');
    //var code = '<span class="c210">zigbeecommand [write: \''+address+'\', reg_address: '+cluster+', i2c_address: '+attribute+']</span>\n';
    var code = '<span class="c210">zbOutput '+onoff+''+output+' '+address+'</span>\n';
    return code;
  };
Blockly.GogoCode['Zigbee_command'] = function(block) {
  var address = Blockly.GogoCode.valueToCode(block, 'address', Blockly.GogoCode.ORDER_ATOMIC);
  var cluster = Blockly.GogoCode.valueToCode(block, 'cluster', Blockly.GogoCode.ORDER_ATOMIC);
  var attribute = Blockly.GogoCode.valueToCode(block, 'attribute', Blockly.GogoCode.ORDER_ATOMIC);
  //var code = '<span class="c210">zigbeecommand [write: \''+address+'\', reg_address: '+cluster+', i2c_address: '+attribute+']</span>\n';
  var code = '<span class="c210">zbCommand '+attribute+' '+cluster+' '+address+'</span>\n';
  return code;
};
Blockly.GogoCode['Zigbee_writeAttr'] = function(block) {
  var address = Blockly.GogoCode.valueToCode(block, 'address', Blockly.GogoCode.ORDER_ATOMIC);
  var cluster = Blockly.GogoCode.valueToCode(block, 'cluster', Blockly.GogoCode.ORDER_ATOMIC);
  var attribute = Blockly.GogoCode.valueToCode(block, 'attribute', Blockly.GogoCode.ORDER_ATOMIC);
  var data = Blockly.GogoCode.valueToCode(block, 'data', Blockly.GogoCode.ORDER_ATOMIC);
  //var code = '<span class="c210">zigbeecommand [write: \''+address+'\', reg_address: '+cluster+', i2c_address: '+attribute+']</span>\n';
  var code = '<span class="c210">zbWriteAttr '+data+' '+attribute+' '+cluster+' '+address+'</span>\n';
  return code;
};
Blockly.GogoCode['Zigbee_readAttr'] = function(block) {
  var address = Blockly.GogoCode.valueToCode(block, 'address', Blockly.GogoCode.ORDER_ATOMIC);
  var cluster = Blockly.GogoCode.valueToCode(block, 'cluster', Blockly.GogoCode.ORDER_ATOMIC);
  var attribute = Blockly.GogoCode.valueToCode(block, 'attribute', Blockly.GogoCode.ORDER_ATOMIC);
  //  var code = '<span class="c210">zigbeeread [reg_address: '+text_reg_addr+', i2c_address: '+text_i2c_addr+']</span>\n';
  var code = '<span class="c210">zbReadAttr '+attribute+' '+cluster+' '+address+'</span>';
    return [code, Blockly.GogoCode.ORDER_NONE];
  };
